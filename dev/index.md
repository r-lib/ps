...
[`ps_pids()`](https://ps.r-lib.org/dev/reference/ps_pids.md) returns all
...
[`ps()`](https://ps.r-lib.org/dev/reference/ps.md) returns a data frame,
...
The [`ps_ppid()`](https://ps.r-lib.org/dev/reference/ps_ppid.md),
...
[`ps_gids()`](https://ps.r-lib.org/dev/reference/ps_uids.md),
[`ps_terminal()`](https://ps.r-lib.org/dev/reference/ps_terminal.md),
[`ps_children()`](https://ps.r-lib.org/dev/reference/ps_children.md) and
the signal sending functions work properly for zombie processes. Other
...
[`ps_wait()`](https://ps.r-lib.org/dev/reference/ps_wait.md), from ps
1.8.0, implements a new way, efficient for waiting on a list of
...
[`ps_wait()`](https://ps.r-lib.org/dev/reference/ps_wait.md), added in
ps 1.8.0.
...
From ps 1.8.0,
[`ps_kill()`](https://ps.r-lib.org/dev/reference/ps_kill.md) will first
send `SIGTERM` signals on Unix, and `SIGKILL` after a grace period, if
needed.
