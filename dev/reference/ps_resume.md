...
Resume process execution with SIGCONT preemptively checking whether PID
has been reused. On Windows this has the effect of resuming all process
threads.
...
p
#> <ps::ps_handle> PID=8503, NAME=sleep, AT=2026-04-20 11:13:10.793392
ps_suspend(p)
#> NULL
ps_status(p)
#> [1] "stopped"
