...
#> 1    13 AF_INET SOCK_STREAM 10.1.0.97 50548 13.35.78.114     443 CONN_…
#> 2    15 AF_INET SOCK_STREAM 10.1.0.97 42346 64.233.180.94    443 CONN_…
#> 3    14 AF_INET SOCK_STREAM 10.1.0.97 32936 172.253.115.95   443 CONN_…
#> 4    16 AF_INET SOCK_STREAM 10.1.0.97 38434 13.35.78.105      80 CONN_…
sc <- socketConnection("httpbin.org", port = 80)
ps_connections(p)
#> # A data frame: 5 × 8
#>      fd family  type        laddr     lport raddr          rport state 
#>   <int> <chr>   <chr>       <chr>     <int> <chr>          <int> <chr> 
#> 1    18 AF_INET SOCK_STREAM 10.1.0.97 56266 54.172.102.128    80 CONN_…
#> 2    13 AF_INET SOCK_STREAM 10.1.0.97 50548 13.35.78.114     443 CONN_…
#> 3    15 AF_INET SOCK_STREAM 10.1.0.97 42346 64.233.180.94    443 CONN_…
#> 4    14 AF_INET SOCK_STREAM 10.1.0.97 32936 172.253.115.95   443 CONN_…
#> 5    16 AF_INET SOCK_STREAM 10.1.0.97 38434 13.35.78.105      80 CONN_…
close(sc)
ps_connections(p)
#> # A data frame: 4 × 8
#>      fd family  type        laddr     lport raddr          rport state 
