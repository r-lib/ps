...
#> 1    14 AF_INET SOCK_STREAM 10.1.0.97 55022 172.253.62.95   443 CONN_E…
#> 2    13 AF_INET SOCK_STREAM 10.1.0.97 57214 13.35.78.126    443 CONN_E…
#> 3    15 AF_INET SOCK_STREAM 10.1.0.97 47182 142.250.31.94   443 CONN_E…
#> 4    16 AF_INET SOCK_STREAM 10.1.0.97 48002 13.35.78.126     80 CONN_E…
...
#>   <int> <chr>   <chr>       <chr>     <int> <chr>         <int> <chr>  
#> 1    14 AF_INET SOCK_STREAM 10.1.0.97 55022 172.253.62.95   443 CONN_E…
#> 2    18 AF_INET SOCK_STREAM 10.1.0.97 56142 52.71.170.232    80 CONN_E…
#> 3    13 AF_INET SOCK_STREAM 10.1.0.97 57214 13.35.78.126    443 CONN_E…
#> 4    15 AF_INET SOCK_STREAM 10.1.0.97 47182 142.250.31.94   443 CONN_E…
#> 5    16 AF_INET SOCK_STREAM 10.1.0.97 48002 13.35.78.126     80 CONN_E…
close(sc)
ps_connections(p)
#> # A data frame: 4 × 8
#>      fd family  type        laddr     lport raddr         rport state  
