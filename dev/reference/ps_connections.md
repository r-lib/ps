...
#> 1    14 AF_INET SOCK_STREAM 10.1.0.200 52208 13.35.78.114    443 CONN_…
#> 2    17 AF_INET SOCK_STREAM 10.1.0.200 42352 13.35.78.124     80 CONN_…
#> 3    16 AF_INET SOCK_STREAM 10.1.0.200 51206 142.251.16.94   443 CONN_…
#> 4    15 AF_INET SOCK_STREAM 10.1.0.200 39344 142.251.16.95   443 CONN_…
sc <- socketConnection("httpbin.org", port = 80)
ps_connections(p)
#> # A data frame: 5 × 8
#>      fd family  type        laddr      lport raddr         rport state 
#>   <int> <chr>   <chr>       <chr>      <int> <chr>         <int> <chr> 
#> 1    19 AF_INET SOCK_STREAM 10.1.0.200 35240 98.94.233.70     80 CONN_…
#> 2    14 AF_INET SOCK_STREAM 10.1.0.200 52208 13.35.78.114    443 CONN_…
#> 3    17 AF_INET SOCK_STREAM 10.1.0.200 42352 13.35.78.124     80 CONN_…
#> 4    16 AF_INET SOCK_STREAM 10.1.0.200 51206 142.251.16.94   443 CONN_…
#> 5    15 AF_INET SOCK_STREAM 10.1.0.200 39344 142.251.16.95   443 CONN_…
close(sc)
ps_connections(p)
#> # A data frame: 4 × 8
#>      fd family  type        laddr      lport raddr         rport state 
