...
#> 1    16 AF_INET SOCK_STREAM 10.1.0.160 38946 13.35.78.114     80 CONN_…
#> 2    15 AF_INET SOCK_STREAM 10.1.0.160 45004 172.253.63.94   443 CONN_…
#> 3    14 AF_INET SOCK_STREAM 10.1.0.160 42466 172.253.62.95   443 CONN_…
#> 4    13 AF_INET SOCK_STREAM 10.1.0.160 34234 13.35.78.126    443 CONN_…
...
#> 3    14 AF_INET SOCK_STREAM 10.1.0.160 42466 172.253.62.95   443 CONN_…
#> 4    13 AF_INET SOCK_STREAM 10.1.0.160 34234 13.35.78.126    443 CONN_…
#> 5    18 AF_INET SOCK_STREAM 10.1.0.160 55300 32.193.85.54     80 CONN_…
close(sc)
ps_connections(p)
#> # A data frame: 4 × 8
#>      fd family  type        laddr      lport raddr         rport state 
