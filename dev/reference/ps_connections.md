...
#> 1    16 AF_INET SOCK_STREAM 10.1.1.102 47304 192.178.155.94   443 CONN…
#> 2    14 AF_INET SOCK_STREAM 10.1.1.102 41414 13.35.78.105     443 CONN…
#> 3    15 AF_INET SOCK_STREAM 10.1.1.102 42158 172.253.122.95   443 CONN…
#> 4    17 AF_INET SOCK_STREAM 10.1.1.102 47328 13.35.78.114      80 CONN…
...
#> 2    14 AF_INET SOCK_STREAM 10.1.1.102 41414 13.35.78.105     443 CONN…
#> 3    15 AF_INET SOCK_STREAM 10.1.1.102 42158 172.253.122.95   443 CONN…
#> 4    19 AF_INET SOCK_STREAM 10.1.1.102 42692 52.6.193.180      80 CONN…
#> 5    17 AF_INET SOCK_STREAM 10.1.1.102 47328 13.35.78.114      80 CONN…
close(sc)
ps_connections(p)
#> # A data frame: 4 × 8
#>      fd family  type        laddr      lport raddr          rport state
