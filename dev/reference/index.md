...
- [`ps()`](https://ps.r-lib.org/dev/reference/ps.md) : Process table
- [`ps_apps()`](https://ps.r-lib.org/dev/reference/ps_apps.md) : List
  currently running applications
- [`ps_pids()`](https://ps.r-lib.org/dev/reference/ps_pids.md) : Ids of
...
- [`ps_cwd()`](https://ps.r-lib.org/dev/reference/ps_cwd.md) : Process
...
- [`ps_environ()`](https://ps.r-lib.org/dev/reference/ps_environ.md)
  [`ps_environ_raw()`](https://ps.r-lib.org/dev/reference/ps_environ.md)
  : Environment variables of a process
- [`ps_exe()`](https://ps.r-lib.org/dev/reference/ps_exe.md) : Full path
  of the executable of a process
- [`ps_handle()`](https://ps.r-lib.org/dev/reference/ps_handle.md)
  [`as.character(`*`<ps_handle>`*`)`](https://ps.r-lib.org/dev/reference/ps_handle.md)
  [`format(`*`<ps_handle>`*`)`](https://ps.r-lib.org/dev/reference/ps_handle.md)
  [`print(`*`<ps_handle>`*`)`](https://ps.r-lib.org/dev/reference/ps_handle.md)
...
- [`ps_name()`](https://ps.r-lib.org/dev/reference/ps_name.md) : Process
  name
- [`ps_num_threads()`](https://ps.r-lib.org/dev/reference/ps_num_threads.md)
  : Number of threads
- [`ps_pid()`](https://ps.r-lib.org/dev/reference/ps_pid.md) : Pid of a
  process handle
- [`ps_ppid()`](https://ps.r-lib.org/dev/reference/ps_ppid.md)
  [`ps_parent()`](https://ps.r-lib.org/dev/reference/ps_ppid.md) :
...
- [`ps_uids()`](https://ps.r-lib.org/dev/reference/ps_uids.md)
  [`ps_gids()`](https://ps.r-lib.org/dev/reference/ps_uids.md) : User
  ids and group ids of the process
...
- [`ps_interrupt()`](https://ps.r-lib.org/dev/reference/ps_interrupt.md)
  : Interrupt a process
- [`ps_kill()`](https://ps.r-lib.org/dev/reference/ps_kill.md) : Kill
...
- [`ps_windows_nice_values()`](https://ps.r-lib.org/dev/reference/ps_get_nice.md)
...
- [`ps_wait()`](https://ps.r-lib.org/dev/reference/ps_wait.md) : Wait
  for one or more processes to terminate, with a timeout

## Users

- [`ps_users()`](https://ps.r-lib.org/dev/reference/ps_users.md) : List
...
- [`ps_fs_info()`](https://ps.r-lib.org/dev/reference/ps_fs_info.md) :
  File system information for files
- [`ps_fs_mount_point()`](https://ps.r-lib.org/dev/reference/ps_fs_mount_point.md)
  : Find the mount point of a file or directory
- [`ps_fs_stat()`](https://ps.r-lib.org/dev/reference/ps_fs_stat.md) :
  File status

## Other system information

- [`ps_boot_time()`](https://ps.r-lib.org/dev/reference/ps_boot_time.md)
  : Boot time of the system
- [`ps_os_type()`](https://ps.r-lib.org/dev/reference/ps_os_type.md)
  [`ps_is_supported()`](https://ps.r-lib.org/dev/reference/ps_os_type.md)
...
- [`ps_loadavg()`](https://ps.r-lib.org/dev/reference/ps_loadavg.md) :
...
- [`ps_string()`](https://ps.r-lib.org/dev/reference/ps_string.md) :

  Encode a `ps_handle` as a short string

- [`signals()`](https://ps.r-lib.org/dev/reference/signals.md) : List of
  all supported signals

- [`errno()`](https://ps.r-lib.org/dev/reference/errno.md) : List of
  'errno' error codes
