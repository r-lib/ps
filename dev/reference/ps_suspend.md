...
Suspend process execution with `SIGSTOP` preemptively checking whether
PID has been reused. On Windows this has the effect of suspending all
process threads.
...
p
#> <ps::ps_handle> PID=8352, NAME=sleep, AT=2026-04-20 16:47:13.006902
ps_suspend(p)
#> NULL
ps_status(p)
#> [1] "stopped"
