...
- [`ps_memory_full_info()`](https://ps.r-lib.org/dev/reference/ps_memory_info.md)
  now contains `maxrss`, the maximum resident set size for the calling
  process.

- New `columns` argument in
  [`ps()`](https://ps.r-lib.org/dev/reference/ps.md), to customize what
  data is returned ([\#138](https://github.com/r-lib/ps/issues/138)).
...
- New [`ps_apps()`](https://ps.r-lib.org/dev/reference/ps_apps.md)
  function to list all running applications on macOS.

- New function
  [`ps_disk_io_counters()`](https://ps.r-lib.org/dev/reference/ps_disk_io_counters.md)
  to query disk I/O counters
  ([\#145](https://github.com/r-lib/ps/issues/145),
  [@michaelwalshe](https://github.com/michaelwalshe)).

- New [`ps_fs_info()`](https://ps.r-lib.org/dev/reference/ps_fs_info.md)
  to query information about the file system of one or more files or
  directories.

- New [`ps_wait()`](https://ps.r-lib.org/dev/reference/ps_wait.md) to
  start an interruptible wait on multiple processes, with a timeout
  ([\#166](https://github.com/r-lib/ps/issues/166)).

- [`ps_handle()`](https://ps.r-lib.org/dev/reference/ps_handle.md) now
...
- [`ps_send_signal()`](https://ps.r-lib.org/dev/reference/ps_send_signal.md),
  ...
  [`ps_kill()`](https://ps.r-lib.org/dev/reference/ps_kill.md), and
  [`ps_interrupt()`](https://ps.r-lib.org/dev/reference/ps_interrupt.md)
  can now operate on multiple processes, if passed a list of process
  handles.

- [`ps_kill()`](https://ps.r-lib.org/dev/reference/ps_kill.md) and
  [`ps_kill_tree()`](https://ps.r-lib.org/dev/reference/ps_kill_tree.md)
  have a new `grace` argument. On Unix, if this argument is not zero,
  then [`ps_kill()`](https://ps.r-lib.org/dev/reference/ps_kill.md)
  first sends a `TERM` signal, and waits for the processes to quit
  gracefully, via
  [`ps_wait()`](https://ps.r-lib.org/dev/reference/ps_wait.md). The
  processes that are still alive after the grace period are then killed
  with `SIGKILL`.

- [`ps_status()`](https://ps.r-lib.org/dev/reference/ps_status.md) (and
  thus [`ps()`](https://ps.r-lib.org/dev/reference/ps.md)) is now better
  at getting the correct status of processes on macOS. This usually
...
- [`ps_name()`](https://ps.r-lib.org/dev/reference/ps_name.md) now does
  not fail in the rare case when
  [`ps_cmdline()`](https://ps.r-lib.org/dev/reference/ps_cmdline.md)
  returns an empty vector
  ([\#150](https://github.com/r-lib/ps/issues/150)).

- [`ps_system_cpu_times()`](https://ps.r-lib.org/dev/reference/ps_system_cpu_times.md)
...
- [`ps::ps_get_cpu_affinity()`](https://ps.r-lib.org/dev/reference/ps_get_cpu_affinity.md)
...
- The output of
  ...
  and
  [`ps_shared_lib_users()`](https://ps.r-lib.org/dev/reference/ps_shared_lib_users.md)
...
- [`ps()`](https://ps.r-lib.org/dev/reference/ps.md) now does not fail
  if both `user` and `after` are specified
...
- New functions
  [`ps_get_cpu_affinity()`](https://ps.r-lib.org/dev/reference/ps_get_cpu_affinity.md)
  and
  [`ps_set_cpu_affinity()`](https://ps.r-lib.org/dev/reference/ps_get_cpu_affinity.md)
...
- New function
  [`ps_loadavg()`](https://ps.r-lib.org/dev/reference/ps_loadavg.md) to
  show the Unix style load average.
...
- New function
  [`ps_descent()`](https://ps.r-lib.org/dev/reference/ps_descent.md) to
...
- New
  [`ps_get_nice()`](https://ps.r-lib.org/dev/reference/ps_get_nice.md)
  and
  [`ps_set_nice()`](https://ps.r-lib.org/dev/reference/ps_get_nice.md)
  functions to get and set the priority of a process
  ([\#89](https://github.com/r-lib/ps/issues/89)).

- New
  [`ps_system_memory()`](https://ps.r-lib.org/dev/reference/ps_system_memory.md)
  and
...
- New
  [`ps_tty_size()`](https://ps.r-lib.org/dev/reference/ps_tty_size.md)
  function to query the size of the terminal.

- Fixed an issue in
  [`CleanupReporter()`](https://ps.r-lib.org/dev/reference/CleanupReporter.md)
...
- [`ps_cpu_count()`](https://ps.r-lib.org/dev/reference/ps_cpu_count.md)
  now reports the correct number on Windows, even if the package binary
  was built on a Windows version with a different API
...
- New function [`errno()`](https://ps.r-lib.org/dev/reference/errno.md)
...
- Fix [`ps()`](https://ps.r-lib.org/dev/reference/ps.md) printing
  without the tibble package
  ([\#43](https://github.com/r-lib/ps/issues/43)).
...
- New [`ps_num_fds()`](https://ps.r-lib.org/dev/reference/ps_num_fds.md)
...
- New [`ps_users()`](https://ps.r-lib.org/dev/reference/ps_users.md)
  lists users connected to the system.

- New
  [`ps_mark_tree()`](https://ps.r-lib.org/dev/reference/ps_kill_tree.md),
  [`ps_find_tree()`](https://ps.r-lib.org/dev/reference/ps_kill_tree.md),
  [`ps_kill_tree()`](https://ps.r-lib.org/dev/reference/ps_kill_tree.md),
  [`with_process_cleanup()`](https://ps.r-lib.org/dev/reference/ps_kill_tree.md):
