...
[`signals()`](https://ps.r-lib.org/reference/signals.md) for the list of
...
- sig:
  ...
  Signal number, see
  [`signals()`](https://ps.r-lib.org/reference/signals.md).
...
p
#> <ps::ps_handle> PID=8415, NAME=sleep, AT=2026-04-20 16:45:03.07573
ps_send_signal(p, signals()$SIGINT)
#> NULL
p
#> <ps::ps_handle> PID=8415, NAME=???, AT=2026-04-20 16:45:03.07573
ps_is_running(p)
#> [1] FALSE
px$get_exit_status()
#> [1] -2
