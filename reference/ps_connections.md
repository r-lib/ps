...
#> 1    15 AF_INET SOCK_STREAM 10.1.0.68 58132 142.251.111.95   443 CONN_…
#> 2    17 AF_INET SOCK_STREAM 10.1.0.68 51818 13.35.78.114      80 CONN_…
#> 3    14 AF_INET SOCK_STREAM 10.1.0.68 60952 13.35.78.124     443 CONN_…
#> 4    16 AF_INET SOCK_STREAM 10.1.0.68 35428 172.253.63.94    443 CONN_…
sc <- socketConnection("httpbin.org", port = 80)
ps_connections(p)
#> # A data frame: 5 × 8
#>      fd family  type        laddr     lport raddr          rport state 
#>   <int> <chr>   <chr>       <chr>     <int> <chr>          <int> <chr> 
#> 1    19 AF_INET SOCK_STREAM 10.1.0.68 37096 3.220.42.21       80 CONN_…
#> 2    15 AF_INET SOCK_STREAM 10.1.0.68 58132 142.251.111.95   443 CONN_…
#> 3    17 AF_INET SOCK_STREAM 10.1.0.68 51818 13.35.78.114      80 CONN_…
#> 4    14 AF_INET SOCK_STREAM 10.1.0.68 60952 13.35.78.124     443 CONN_…
#> 5    16 AF_INET SOCK_STREAM 10.1.0.68 35428 172.253.63.94    443 CONN_…
close(sc)
ps_connections(p)
#> # A data frame: 4 × 8
#>      fd family  type        laddr     lport raddr          rport state 
