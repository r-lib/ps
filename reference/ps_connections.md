...
#> 1    14 AF_INET SOCK_STREAM 10.1.0.175 40558 172.253.122.95   443 CONN…
#> 2    16 AF_INET SOCK_STREAM 10.1.0.175 34522 13.35.78.126      80 CONN…
#> 3    13 AF_INET SOCK_STREAM 10.1.0.175 51182 13.35.78.126     443 CONN…
#> 4    15 AF_INET SOCK_STREAM 10.1.0.175 57248 142.251.163.94   443 CONN…
...
#> 2    16 AF_INET SOCK_STREAM 10.1.0.175 34522 13.35.78.126      80 CONN…
#> 3    13 AF_INET SOCK_STREAM 10.1.0.175 51182 13.35.78.126     443 CONN…
#> 4    18 AF_INET SOCK_STREAM 10.1.0.175 37568 52.71.108.149     80 CONN…
#> 5    15 AF_INET SOCK_STREAM 10.1.0.175 57248 142.251.163.94   443 CONN…
close(sc)
ps_connections(p)
#> # A data frame: 4 × 8
#>      fd family  type        laddr      lport raddr          rport state
