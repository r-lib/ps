...
Named integer vector of length 3, with names: `real`, `effective` and
`saved`.
...
[`ps_username()`](https://ps.r-lib.org/reference/ps_username.md) returns
a user *name* and works on all platforms.
