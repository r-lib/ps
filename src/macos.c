 ...
 */
static PyObject *
ps__boot_time(PyObject *self, PyObject *args) {
 ...
 */
static PyObject *
ps__proc_connections(PyObject *self, PyObject *args) {
  long pid;
  int pidinfo_result;
  int iterations;
  int i;
 ...
 */
static PyObject *
ps__proc_num_fds(PyObject *self, PyObject *args) {
  long pid;
  int pidinfo_result;
  int num;
